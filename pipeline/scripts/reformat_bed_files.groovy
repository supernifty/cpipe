...
annotate = {
    exec """
        ...
        JAVA_OPTS="-Xmx1g" $BASE/tools/groovy/2.1.1/bin/groovy -cp $GROOVY_NGS/groovy-ngs-utils.jar $BASE/pipeline/scripts/annotate_genes.groovy -r $BASE/tools/annovar/humandb/hg19_refGene.txt $input.bed > $output.bed
    """
}
